...
from lalamo.sampling import DenseLogits, SamplingPolicy
...
def decode_next_token(
    ...
    *,
    ...
    def loop_iteration(
        ...
        loop_input: tuple[Int[Array, ""], Array],
...
def _sample_with_previous_tokens(
    ...
    *,
    ...
    if previous_tokens is None:
        return sampling_policy(DenseLogits(values=logits), keychain=keychain)
    ...
    return sampling_policy(DenseLogits(values=adjusted_logits), keychain=keychain)
