...
class DecoderActivationTrace(ExportableModule):
    ...
    def export_weights(self, weight_layout: WeightLayout = WeightLayout.INPUT_OUTPUT) -> ParameterDict:
        ...
        if self.kv_cache is not None:
            result["kv_cache"] = [kv_cache_layer_slice.export_weights(weight_layout) for kv_cache_layer_slice in self.kv_cache]
...
class DecoderResult(ExportableModule):
    ...
    def export_weights(self, weight_layout: WeightLayout = WeightLayout.INPUT_OUTPUT) -> ParameterDict:
        ...
        if self.updated_kv_cache is not None:
            result["updated_kv_cache"] = [kv_cache_layer_slice.export_weights(weight_layout) for kv_cache_layer_slice in self.updated_kv_cache]
