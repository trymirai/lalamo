...
GEMMA4 = [
    ...
    LanguageModelSpec(
        vendor="Google",
        family="Gemma-4",
        name="gemma-4-e2b-it-MLX-bf16",
        size="5B",
        origin=HuggingFaceOrigin(repo="mlx-community/gemma-4-e2b-it-bf16"),
        config_type=HFGemma4Config,
        configs=ConfigMap(chat_template=FileSpec("chat_template.jinja")),
    ),
    LanguageModelSpec(
        ...
        size="5B",
        origin=HuggingFaceOrigin(repo="mlx-community/gemma-4-e2b-it-4bit"),
        config_type=HFGemma4Config,
        configs=ConfigMap(chat_template=FileSpec("chat_template.jinja")),
    ),
    LanguageModelSpec(
