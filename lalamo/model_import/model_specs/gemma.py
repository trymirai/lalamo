...
GEMMA2 = [
    ModelSpec(
        ...
        size="2B",
        quantization=None,
        source=HuggingFaceOrigin(repo="google/gemma-2-2b-it"),
...
GEMMA3 = [
    ModelSpec(
        ...
        size="1B",
        quantization=None,
        source=HuggingFaceOrigin(repo="google/gemma-3-1b-it"),
    ...
    ModelSpec(
        ...
        source=HuggingFaceOrigin(repo="mlx-community/gemma-3-1b-it-4bit"),
        config_type=HFGemma3TextConfig,
    ...
    ModelSpec(
        ...
        source=HuggingFaceOrigin(repo="mlx-community/gemma-3-1b-it-8bit"),
        config_type=HFGemma3TextConfig,
        configs=ConfigMap(generation_config=FileSpec("generation_config.json", "google/gemma-3-1b-it")),
    ),
    ModelSpec(
        ...
        size="4B",
        quantization=None,
        source=HuggingFaceOrigin(repo="google/gemma-3-4b-it"),
    ...
    ModelSpec(
        ...
        size="4B",
        quantization=QuantizationMode.UINT4,
        source=HuggingFaceOrigin(repo="mlx-community/gemma-3-4b-it-4bit"),
        config_type=HFGemma3Config,
    ...
    ModelSpec(
        ...
        size="4B",
        quantization=QuantizationMode.UINT8,
        source=HuggingFaceOrigin(repo="mlx-community/gemma-3-4b-it-8bit"),
        config_type=HFGemma3Config,
        configs=ConfigMap(generation_config=FileSpec("generation_config.json", "google/gemma-3-4b-it")),
    ),
    ModelSpec(
        ...
        size="27B",
        quantization=None,
        source=HuggingFaceOrigin(repo="google/gemma-3-27b-it"),
        config_type=HFGemma3Config,
    ),
    ModelSpec(
        vendor="Google",
        ...
        size="27B",
        quantization=QuantizationMode.UINT4,
        source=HuggingFaceOrigin(repo="mlx-community/gemma-3-27b-it-4bit"),
        config_type=HFGemma3Config,
    ...
    ModelSpec(
        ...
        size="27B",
        quantization=QuantizationMode.UINT8,
        source=HuggingFaceOrigin(repo="mlx-community/gemma-3-27b-it-8bit"),
        config_type=HFGemma3Config,
        configs=ConfigMap(generation_config=FileSpec("generation_config.json", "google/gemma-3-27b-it")),
    ),
    ModelSpec(
        ...
        size="270M",
        quantization=None,
        source=HuggingFaceOrigin(repo="google/functiongemma-270m-it"),
        config_type=HFGemma3TextConfig,
