...
__all__ = ["HFQwen35MoeConfig"]


@dataclass(frozen=True)
class HFQwen35MoeConfig(HuggingFaceLMConfig):
    ...
    def from_json(cls, json_path: Path | str) -> Self:
        ...
        with open(json_path) as f:
            config = json.load(f)
        # Qwen3.5-MoE is a multimodal VLM: text model params live under text_config;
        # top-level keys (e.g. model_type for the composite model) override text_config.
    ...
    def to_decoder_config(
        ...
        # but MLX community converters bake the +1 into the weights.
        ...
        # DeltaNet RMSNorm uses direct weights (no +1 offset).
