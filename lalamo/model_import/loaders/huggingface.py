...
def load_gemma4_moe_block(
    ...
    *,
    ...
    down_projection = _update_linear(
        ...
        load_full_precision(module.experts.down_projection.weights, down_weights),
        None,
    )
    experts = load_as_at(
