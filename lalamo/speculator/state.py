...
class StateRequest:
    ...
    def __post_init__(self) -> None:
        assert (
            self.layer_capacity > 0 or self.layer_indices == ()
        ), "layer_capacity must be positive when layer_indices is non-empty."
...
def build_prefill_memory(state_request: StateRequest, activation_trace: DecoderActivationTrace) -> MemoryBuffers:
    token_ids = None
