...
MODEL_TIERS: tuple[tuple[str, ModelTier], ...] = (
    ...
    ("mlx-community/LFM2.5-1.2B-Instruct-4bit", ModelTier.STANDARD),
    ("LiquidAI/LFM2-350M", ModelTier.EXTRA),
    ("LiquidAI/LFM2.5-350M", ModelTier.EXTRA),
    ...
    ("mlx-community/Qwen3.5-27B-MLX-8bit", ModelTier.STANDARD),
    ...
    ("mlx-community/Qwen3.5-27B-MLX-4bit", ModelTier.EXTRA),
    # AWQ
